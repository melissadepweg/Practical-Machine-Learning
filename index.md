...
The J48 returns an accuracy of 99.57% on the training data set with no cross-validation. The accuracy reduces down to 97.47% with 10-fold cross-validation and also has 98.42% accuracy on the test data set. 
...
The PCA J48 returns an accuracy of 91.58% on the training data set with no cross-validation. The accuracy reduces down to 81.25% with 10-fold cross-validation and also has 82.44% accuracy on the test data set. 
